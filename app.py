...
('Vacination Comparison', 'Deaths Tracker', 'New Cases', 'Comparison
Rates(CDR)'))
...
option_selectbox = st.sidebar.multiselect('Select a Multi
Manufacturers:', cols_c, cols_c[1], key=4)
...
option = st.sidebar.multiselect('Which state(s) do you want in
track?', cols, cols[39])
